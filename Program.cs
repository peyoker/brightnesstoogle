...
namespace NoBright
{
    ...
    public class AboutForm : Form
    {
        public AboutForm(string[] texts)
        {
            ...
            // Icono/Logo (usaríamos el icono de la app)
            PictureBox icon = new PictureBox();
            icon.Location = new Point(160, yPos);
            ...
            lblDesc.Location = new Point(20, yPos);
            lblDesc.Size = new Size(360, 60);
            ...
            linkGitHub.Size = new Size(400, 20);
    ...
    public class ConfigForm : Form
    {
        ...
        private string[] texts_en = new string[] {
            ...
            // About dialog
            "About NoBright",
            "A lightweight Windows utility for intelligent screen brightness control. Perfect for late-night sessions.",
            "License: GPL-3.0",
            "Close"
        };
        ...
        private string[] texts_es = new string[] {
            ...
            // About dialog
            "Acerca de NoBright",
            "Una utilidad ligera de Windows para control inteligente del brillo. Perfecta para sesiones nocturnas.",
            "Licencia: GPL-3.0",
            "Cerrar"
        };
        ...
        private void CreateMenuStrip()
        {
            ...
            ToolStripMenuItem logEnable = new ToolStripMenuItem(currentTexts[15]);
            logEnable.CheckOnClick = true;
            logEnable.Checked = Properties.Settings.Default.EventLogEnabled;
            logEnable.Click += (s, e) => {
                Properties.Settings.Default.EventLogEnabled = logEnable.Checked;
                Properties.Settings.Default.Save();
            };
            logMenu.DropDownItems.Add(logEnable);
            ...
            helpAbout.Click += (s, e) => {
                AboutForm about = new AboutForm(new string[] {
                    currentTexts[35], currentTexts[36], currentTexts[37], currentTexts[38]
                });
                about.ShowDialog();
            };
        ...
        {
            Color backColor, foreColor, logBackColor, logForeColor;
    ...
    static class Program
    {
        ...
        static async Task SmoothTransition(bool toOverlay)
        {
            ...
            configForm?.LogMessage("Smooth transition completed");
        }
        ...
        public static async void ToggleBrightness()
        {
            ...
            if (!brightnessIsLow)
            {
                ...
                configForm?.LogMessage("✓ Screen darkened");
            }
            else
            {
                ...
                configForm?.LogMessage("✓ Screen restored to normal");
            }
        }
                ...
                try
                {
                    ...
                    if (isLocked != wasLocked)
                    {
                        ...
                        if (brightnessIsLow)
                        {
                            if (isLocked)
                            {
                                configForm?.LogMessage("Lock screen detected - switching to overlay mode");
                            ...
                            {
                                configForm?.LogMessage("Session unlocked - switching to brightness mode");
                                await SmoothTransition(false);
                            }
                        }
                    }
